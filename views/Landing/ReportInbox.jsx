...
const ReportInbox = ({}) => {
    ...
    const handleSend = () => {
        ...
        setLoader(true)
        axiosRequest.post(`gabay/report/problem/?type=Report`,{from_email : context.email,subject:`Report: ${subject}`,message:plainTextContent})
        .then((response)=>{
    ...
    <ScrollView style={{ ...styles.editorContainer }}>
        <RichEditor
            ...
            ref={richText}
            onChange={(text) => {
                // const plainTextContent = stripHtmlTags(text)
                setMessage(text);
...
{/*                 
                ...
                <ModalMessage showAutomatically={showModalMessage} message="Report message send!" icon={<MaterialCommunityIcons name="comment-check" size={200} color="#E3B448" />}navigateToScreen="Settings"/>
